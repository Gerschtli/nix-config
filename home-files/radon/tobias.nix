    ...
    profiles =
      let
        fingerprints = {
          ...
          # home office
          DP-2-1 = "";
        };

        mkConfigObject = config: mkMerge [
          {
            DP-1-1.enable = mkDefault false;
            DP-2-1.enable = mkDefault false;
      ...
      in
        {
          ...
          home = {
            fingerprint = {
              inherit (fingerprints) eDP-1 DP-2-1;
            };
